...
extern bool MainMenuPopupButtonOnMouseUp(ITUWidget* widget, char* param);
extern bool MainMenuPopupButtonOnLongPress(ITUWidget* widget, char* param);
extern bool MainMenuCoverFlowOnChange(ITUWidget* widget, char* param);
...
extern bool AudioPlayerRandomButtonOnPress(ITUWidget* widget, char* param);
...
extern bool VideoPlayerRandomButtonOnPress(ITUWidget* widget, char* param);
...
extern bool ButtonSpriteButtonOnPress(ITUWidget* widget, char* param);
...
extern bool CircleCtrlMeterTrackBarOnChange(ITUWidget* widget, char* param);
...
extern bool CheckListScrollIconListBoxReflesh(ITUWidget* widget, char* param);
extern bool CheckListScrollListBoxReflesh(ITUWidget* widget, char* param);
...
ITUActionFunction actionFunctions[] =
{
    ...
    "MainMenuPopupButtonOnMouseUp", MainMenuPopupButtonOnMouseUp,
    "MainMenuPopupButtonOnLongPress", MainMenuPopupButtonOnLongPress,
    "MainMenuCoverFlowOnChange", MainMenuCoverFlowOnChange,
	...
	"AudioPlayerRandomButtonOnPress", AudioPlayerRandomButtonOnPress,
	...
	"VideoPlayerRandomButtonOnPress", VideoPlayerRandomButtonOnPress,
    ...
    "ButtonSpriteButtonOnPress", ButtonSpriteButtonOnPress,
    ...
    "CircleCtrlMeterTrackBarOnChange", CircleCtrlMeterTrackBarOnChange,
	...
	"CheckListScrollIconListBoxReflesh", CheckListScrollIconListBoxReflesh,
	"CheckListScrollListBoxReflesh", CheckListScrollListBoxReflesh,
    NULL, NULL
};
